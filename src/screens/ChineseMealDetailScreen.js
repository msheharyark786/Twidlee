...
const ChineseMealDetailScreen = props => {
  const mealId = props.navigation.getParam('mealId');

  const selectedMeal = Chinese_MEALS.find(meal => meal.id === mealId);
...
ChineseMealDetailScreen.navigationOptions = navigationData => {
...
export default ChineseMealDetailScreen;
